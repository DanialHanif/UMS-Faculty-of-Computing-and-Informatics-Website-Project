                ...
                <div id="" class="w-100">
                    ...
                    if (!is_null($news->getResult())) {
                        foreach ($news->getResult() as $row)
                            echo "<li style=\"list-style-type: none;\"><h6 class=\"text-justify\"><a class=\"text-body\" href=\"$row->slug\">" . $row->title . "</a><br><br><p class=\"font-weight-normal\">$row->body</p><p class=\"text-right font-weight-normal\">—" . $row->date . "<p></h6><br></li>";
                    } else {
                        echo "<h3>No News</h3>";
