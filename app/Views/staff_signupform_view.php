<body class="d-flex flex-column h-100">
    <main role="main" class="mx-auto flex-shrink-0" style="max-width: 1200px; width: 100%; background-color: white;">
        ...
        <div class="container">
            ...
            <?php endif; ?>
            <form class="needs-validation" id="formSignUp" action="<?= base_url('StaffSignup/addnew') ?>" method="post">
                
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="name"><b>First Name</b></label>
                        <input type="text" class="form-control" placeholder="Enter First Name" name="cFirstName" value="<?= set_value('cFirstName')?>" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="name"><b>Last Name</b></label>
                        <input type="text" class="form-control" placeholder="Enter Last Name" name="cLastName" value="<?= set_value('cLastName')?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="cCountry"><b>County</b></label>
                    <select name="cCountry" class="custom-select">
                ...
                <div class="form-group">
                    <label for="officeCode"><b>Office Code</b></label>
                    <select name="officeCode" class="custom-select">
                    <option value="" disabled="disabled" selected>Please Select</option>
                ...
                <div class="form-group">
                  <label for="reportsTo"><b>Supervisor's ID</b></label>
                  <input type="text" name="reportsTo" class="form-control" placeholder="Enter your supervisor's ID (if any)" value="<?= set_value('reportsTo')?>">
                </div>

                <div class="form-group">
                    <label for="email"><b>Login Email</b></label>
                    <input type="email" class="form-control" placeholder="Enter Email" name="cEmail" value="<?= set_value('cEmail')?>" required>
                </div>
                <div class="form-group">
                    <label for="password"><b>Login Password</b></label>
                    <input type="password" class="form-control" placeholder="Enter Password" name="cPassword" value="<?= set_value('cPassword')?>" required>
                </div>
